 ...
 */
public class FindDeviceHook implements IHook {
    ...
    public void hook() {
        try {
            ...
            Class<?> EncryptLogSender = Util.getClassLoader()
                .loadClass("com.xiaomi.finddevice.common.log.EncryptLogSender");
            Method logAtLevelImp = XposedHelpers.findMethodExact(XLogger, "logAtLevelImp", int.class, String.class,
                Object[].class);
            XposedBridge.hookMethod(logAtLevelImp, XC_MethodReplacement.DO_NOTHING);
            Method sendLogLocked = XposedHelpers.findMethodExact(SwitchFileLogSender, "sendLogLocked", int.class,
                String.class, String.class);
            Method sendLog = XposedHelpers.findMethodExact(EncryptLogSender, "sendLog", int.class, String.class,
                String.class);
